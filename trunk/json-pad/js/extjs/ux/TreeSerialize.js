...
Ext.tree.TreeSerializer.prototype = {
     ...
     */
    standardAttributes: ["expanded", "allowDrag", "allowDrop", "disabled", "icon", "cls", "iconCls", "href", "hrefTarget", "qtip", "singleClickExpand", "uiProvider"],
...
Ext.extend(Ext.tree.XmlTreeSerializer, Ext.tree.TreeSerializer, {
	...
	return '\u003C?xml version="1.0"?>\u003Ctree>' + nodeToString(this.getRootNode()) + '\u003C/tree>';
    },
