...
"null")editKeyForm.keyForm.jsonvalue.disable();else editKeyForm.keyForm.jsonvalue.enable();editKeyForm.enableKeyForm()}else{editKeyForm.enableObjectForm();editKeyForm.objectForm.jsonIndex.setValue(nodeText);if(n.parentNode.attributes.type=="array"){editKeyForm.objectForm.jsonIndex.setValue("ARRAY VALUE");editKeyForm.objectForm.jsonIndex.disable()}else editKeyForm.objectForm.jsonIndex.enable()}}JP.MainCenter.Action.tree.setTreePath(n,this);return true},me)}});Ext.reg("jp_main_center_jsonTree",JP.MainCenter.jsonTree);JP.MainCenter.jsonTree.nodeToolbar=Ext.extend(Ext.Toolbar,{ref:"treetools",initComponent:function(){this.items=[{xtype:"button",iconCls:"icon_tree_addKey",tooltip:"Add a key/object/array",ref:"addNode",menu:{ref:"menu",items:[{xtype:"menuitem",text:"Add key",ref:"addKey"},{xtype:"tbseparator"},{xtype:"menuitem",text:"Add object",ref:"addObject"},{xtype:"menuitem",text:"Add array",ref:"addArray"}]}},{xtype:"button",iconCls:"icon_tree_duplicate",tooltip:"Duplicate selected node",disabled:true,ref:"duplicateNode"},
